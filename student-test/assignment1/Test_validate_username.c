...
void test_validate_my_username()
{
     ...
     */
    if(strcmp(my_username(),malloc_username_from_conf_file())==0)
    {

        TEST_ASSERT_TRUE_MESSAGE(true, my_username()); 
    }
    else
    {
        TEST_ASSERT_TRUE_MESSAGE(false,"The usernames don't match!");
    }
}
